...
public:
    void TestMonolayer()
    {
        HoneycombVertexMeshGenerator generator(7, 7);    // Parameters are: cells across, cells up
        ...
        simulator.SetOutputDirectory("EclipseTensionWriter1");
        ...
        point(0) = 9.0;                                    //Creates a normal to the plane where x = 10 is always true.
        normal(0) = 1.0;
